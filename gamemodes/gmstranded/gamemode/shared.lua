...
GM.GroupData = {
	...
	["owner"] 	= { name = "Owner", 	color = Color( 234, 198, 0, 255 ) },
	["manager"] 	= { name = "Manager", 	color = Color( 160, 0, 0, 255 ) },
...
AmIAdmin = {}
AmIAdmin["superadmin"] = true
AmIAdmin["owner"] = true
AmIAdmin["manager"] = true
AmIAdmin["admin"] = true
AmIAdmin["moderator"] = true function PlayerMeta:AmIAdmin()return AmIAdmin[self:GetNWString("usergroup")]
end

SGS.maxguestprops = 50
SGS.maxmemberprops = 100
SGS.maxdonatorprops = 150
SGS.maxstaffprops = 200
