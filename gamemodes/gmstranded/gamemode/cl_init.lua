...
function GM:InitPostEntity()
	...
	MsgC( Color( 0, 255, 0 ), "Stranded Lua Loaded Successfully!\n" )
end
...
concommand.Add( "sgs_clearragdolls", clearragdolls )