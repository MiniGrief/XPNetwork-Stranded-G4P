...
function PANEL:DrawFrame()
	...
	function DrawResources()
		...
		gtLabel:SetText("XPTokens: " .. tostring( SGS.gtokens )) // Text
...
function PANEL:DrawFrame()
	...
	HTMLTest:OpenURL("https://xpnetwork.online/stranded/rules.html")
...
function PANEL:Paint( w, h )
	...
	draw.SimpleTextOutlined( " |XPNetwork| Stranded ", "ScoreboardDefaultTitle", 8, 0, Color(255,255,255,255), TEXT_ALIGN_LEFT, TEXT_ALIGN_LEFT, 2, Color(0,0,0,255))
