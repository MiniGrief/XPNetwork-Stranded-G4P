...
function PANEL:DrawFrame()
	...
	GAMEMODE.NewMenu.btn_option8:DockMargin( 2, 2, 4, 0 )
	...
	GAMEMODE.NewMenu.btn_option8.OnMousePressed = function()
		...
		if ValidPanel(self.content) then self.content:Remove() end
		self.content = vgui.Create( "member_panel", content_window )
		self.content:Dock( FILL )
		self.content:DockMargin( 0, 0, 0, 0 )
	end
...
function MOTD:Init()
	...
	HTML:Dock( FILL )
	HTML:OpenURL("https://xpnetwork.online/stranded/rules.html")
end
function MOTD:Paint()
...
function WIKI:Init()
	local HTML = vgui.Create("DHTML", self)
	HTML:Dock( FILL )
	HTML:OpenURL("https://xpnetwork.online/stranded/wiki/index.php/Main_Page")
end
function WIKI:Paint()
...
function GUIDE:Init()
	local HTML = vgui.Create("DHTML", self)
	HTML:Dock( FILL )
	HTML:OpenURL("https://xpnetwork.online/stranded/guidechoose.html")
end
...
function MEMBER:Init()
	local HTML = vgui.Create("DHTML", self)
	HTML:Dock( FILL )
	HTML:OpenURL("https://xpnetwork.online/stranded/leaderboard.php")
end
function MEMBER:Paint()

end
vgui.Register("member_panel", MEMBER, "Panel")

local FORUMS = {}
function FORUMS:Init()
	local HTML = vgui.Create("DHTML", self)
	HTML:Dock( FILL )
	HTML:OpenURL("https://xpnetwork.online/forum")
end
...
function DONATE:Init()
	local HTML = vgui.Create("DHTML", self)
	HTML:Dock( FILL )
	HTML:OpenURL("https://xpnetwork.online/stranded/donate.html")
end
