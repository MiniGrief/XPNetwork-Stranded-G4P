...
SGS_RegisterStat( "general", "general13", "XPTokens Found" ) --Done
SGS_RegisterStat( "general", "general14", "XPTokens Spent" ) --Done
...
SGS_RegisterStat( "combat", "combat7", "Times killed Tomato" )
