...
local files, dirs = file.Find("gamemodes/gmstranded/content/materials/vgui/sifters/*", "GAME")
for k, v in pairs( files ) do
	resource.AddFile("materials/vgui/sifters/" .. v)
end

/*
Shop Icons
*/
local files, dirs = file.Find("gamemodes/gmstranded/content/materials/vgui/shop/*", "GAME")
for k, v in pairs( files ) do
	resource.AddFile("materials/vgui/shop/" .. v)
end
