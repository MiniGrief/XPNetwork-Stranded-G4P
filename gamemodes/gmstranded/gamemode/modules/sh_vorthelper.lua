...
SGS.VortHelper[3] = {}
SGS.VortHelper[3].trigger = "xptoken"
SGS.VortHelper[3].response = "XPTokens are used to buy things from me. You find them rarely by playing the game, or you can also get them if you donate."

SGS.VortHelper[4] = {}
SGS.VortHelper[4].trigger = "donate"
SGS.VortHelper[4].response = "If you'd like to donate, check out our donate page. https://xpnetwork.online"
