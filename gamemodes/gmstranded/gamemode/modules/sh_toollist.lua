...
RECIPE.icon = "vgui/tools/wood_melee_new.png"
...
RECIPE.icon = "vgui/tools/iron_melee_new.png"
Menu_RegisterTool( "combat", RECIPE )
...
RECIPE.icon = "vgui/tools/steel_melee_new.png"
Menu_RegisterTool( "combat", RECIPE )
...
RECIPE.icon = "vgui/tools/silver_melee_new.png"
Menu_RegisterTool( "combat", RECIPE )
...
RECIPE.icon = "vgui/tools/trinium_melee_new_new.png"
...
RECIPE.icon = "vgui/tools/naquadah_melee_new_new.png"
...
RECIPE.icon = "vgui/tools/mithril_melee_new.png"
Menu_RegisterTool( "combat", RECIPE )
...
RECIPE.icon = "vgui/tools/platinum_melee_new.png"
Menu_RegisterTool( "combat", RECIPE )
...
RECIPE.icon = "vgui/sifters/iron_sifter_new.png"
RECIPE.color = Vector(.45, .3, .3)
...
RECIPE.icon = "vgui/sifters/steel_sifter_new.png"
RECIPE.color = Vector(.6, .6, .8)
Menu_RegisterTool( "sifting", RECIPE )
...
RECIPE.icon = "vgui/sifters/trinium_sifter_new.png"
RECIPE.color = Vector(.1, .3, .1)
Menu_RegisterTool( "sifting", RECIPE )
...
RECIPE.icon = "vgui/sifters/mithril_sifter_new.png"
RECIPE.color = Vector(.1, .1, .4)
Menu_RegisterTool( "sifting", RECIPE )
...
RECIPE.icon = "vgui/tools/boss_melee_new.png"
Menu_RegisterTool( "boss", RECIPE )
...
RECIPE.model = "models/c_pickaxe/c_pickaxe.mdl"
RECIPE.skin = 1
RECIPE.title = "Blood Pickaxe"
RECIPE.description = "Very powerful mining tool!\nPrimary: Mine Ore\nRequired Mining Lvl: 71"
RECIPE.cost = {congealed_blood = 5, enchanted_wood = 4}
RECIPE.reqlvl = { smithing = 72}
RECIPE.uselevel = { mining = 71}
RECIPE.xp = 10000
RECIPE.entity = "gms_bloodpickaxe"
RECIPE.color = Vector(1, .1, 0)
RECIPE.icon = "vgui/tools/blood_pickaxe.png"
Menu_RegisterTool( "blood", RECIPE )

RECIPE = {}
RECIPE.model = "models/c_pickaxe/c_pickaxe.mdl"
RECIPE.skin = 1
RECIPE.title = "Blood Hatchet"
RECIPE.description = "Very powerful tree cutting tool!\nPrimary: Chop Tree\nRequired Mining Lvl: 71"
RECIPE.cost = {congealed_blood = 5, enchanted_wood = 4}
RECIPE.reqlvl = { smithing = 72}
RECIPE.uselevel = { woodcutting = 71}
RECIPE.xp = 10000
RECIPE.entity = "gms_bloodhatchet"
RECIPE.color = Vector(1, .1, 0)
RECIPE.icon = "vgui/tools/blood_pickaxe.png"
Menu_RegisterTool( "blood", RECIPE )
...
RECIPE.model = "models/rods/c_boss_rod/c_boss_rod.mdl"
RECIPE.skin = 1
RECIPE.title = "Blood Rod"
RECIPE.description = "Very powerful combat weapon!\nPrimary: Attack\nRequired Combat Lvl: 55"
RECIPE.cost = {congealed_blood = 5, enchanted_wood = 4}
RECIPE.reqlvl = { smithing = 50}
RECIPE.uselevel = { combat = 55}
RECIPE.xp = 10000
RECIPE.entity = "weapon_bloodmelee"
RECIPE.icon = "vgui/tools/boss_melee_new.png"
Menu_RegisterTool( "blood", RECIPE )
