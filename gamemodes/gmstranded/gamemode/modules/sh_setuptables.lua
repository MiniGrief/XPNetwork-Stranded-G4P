function SGS_SetUpTablesShared()
	...
	SGS.VortChatMessages = {
		...
		"Did you find a Void Cache? I will sell you the crystal to open it. Only 1k XPTokens!",
		...
		"Watch the time! We restart at 4 PM (PST) on Wednesday and Saturday.",
		"Becareful on Saturday. That day is when we wipe the map as the server restarts at 4 PM (PST).",
		"Want to join our Discord and chat to fellow players? Use this link: https://discord.gg/3KZ58f9",
		"Want to check out our website? Use this link: https://xpnetwork.online",
		"Do you really call THAT a base, %P? I've seen better latrines on Xen."
	}
							
	SGS.BreenChatMessages = {
		"Where am I? This isn't right. ",
		"Tis the season... for savings! Come see me for holiday specials!",
		"Bring your Snowflakes to me! I'll trade them for some fun stuff!",
	...
	SGS.adtext = "To report bugs or make suggestions, please visit our site at xpnetwork.online"
	SGS.adcolors = {
			Color(255,255,0,255),
			Color(255,0,255,255),
			Color(0,255,255,255),
