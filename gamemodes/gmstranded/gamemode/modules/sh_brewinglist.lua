...
//-=Event=-//
RECIPE = {}
RECIPE.title = "Christmas Cracker"
RECIPE.material = "vgui/error.png"
RECIPE.ptype = "event"
RECIPE.uid = "christmas_cracker"
RECIPE.mname = "christmas_cracker"
RECIPE.description = "Use this with a friend and find out what is inside!"
RECIPE.alttext = "Using Cracker..."
Menu_RegisterBrewing( "achievement", RECIPE )