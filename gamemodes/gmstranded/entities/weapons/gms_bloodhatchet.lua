...
SWEP.ViewModel			= "models/c_void_hatchet/c_void_hatchet.mdl"
SWEP.WorldModel			= "models/c_void_hatchet/c_void_hatchet.mdl"
SWEP.UseHands			= true
...
function SWEP:PrimaryAttack()
	...
	SGS_Lumber( ply, trace.Entity, timemodi, modi, nil, true )
