...
function SWEP:PrimaryAttack( right )
	...
	if ply:GetLevel("combat") >= 55 then
		...
		if tr.Hit then
			...
			if IsValid(ent) then
				if SERVER then
					...
					dmg:SetDamage( math.random(100,120) )
		...
		ply:SendMessage("This weapon requires a level 55 or higher in combat.", 60, Color(255, 125, 0, 255))
	end
