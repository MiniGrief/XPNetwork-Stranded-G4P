...
function EFFECT:Init( data )
	...
	local Col = Color(255,255,255,255) // Meteor
	//local Col = Color(0,0,4,100) // Comet
	...
	local emitter = ParticleEmitter( self.Origin, false )
		...
		for i=0, NumParticles do
			...
			newstart = newstart + Vector(math.Rand(-50,20),math.Rand(-80,80),math.Rand(15,20))
			...
			if ColorParticleStreak then
				...
				local Size = math.Rand( 15, 30 )
				ColorParticleStreak:SetStartSize( Size )
				ColorParticleStreak:SetEndSize( math.random(10,20) )
